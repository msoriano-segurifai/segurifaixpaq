    ...
    <div className="min-h-screen bg-gradient-to-br from-red-700 via-red-600 to-red-500 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">MAWDY - Panel de Administración</h1>
          <p className="text-red-200 mt-2">Administración de MAWDY</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <button
              type="button"
              onClick={() => { setEmail('admin@mawdy.gt'); setPassword('TestPassword123!'); }}
