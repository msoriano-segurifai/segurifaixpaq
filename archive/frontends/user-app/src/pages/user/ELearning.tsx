...
export const ELearning: React.FC = () => {
  ...
  const startModule = async (module: Module) => {
    ...
    try {
      ...
      alert('Error al cargar el mÃ³dulo');
    } finally {
      ...
      <Layout variant="user">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600 font-medium">Cargando mÃ³dulos educativos...</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <div className="space-y-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              ...
              <div className="bg-white/20 rounded-2xl p-5 backdrop-blur-sm border border-white/30 hover:bg-white/30 transition-all">
                ...
                <p className="text-sm text-blue-100">CrÃ©ditos Ganados</p>
              </div>
              ...
              <div className="bg-white/20 rounded-2xl p-5 backdrop-blur-sm border border-white/30 hover:bg-white/30 transition-all">
                ...
                <p className="text-sm text-blue-100">MÃ³dulos Completos</p>
              </div>
            ...
            <div className="mt-6 bg-white/20 rounded-2xl p-5 backdrop-blur-sm border border-white/30">
              ...
              <p className="text-sm text-blue-100 mt-2">
                {completedCount === modules.length
                  ? 'ðŸŽ‰ Â¡Felicidades! Has completado todos los mÃ³dulos'
                  : `Te faltan ${modules.length - completedCount} mÃ³dulo${modules.length - completedCount !== 1 ? 's' : ''} para completar`}
              </p>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-2xl p-5 backdrop-blur-sm border-2 border-yellow-400/50">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-lg mb-2">ðŸ’° Sistema de Recompensas</h3>
                  <p className="text-blue-100 leading-relaxed">
                    Por cada <strong>20 puntos</strong> que acumules, ganas <strong>Q1.00 en crÃ©ditos</strong>.
                    Estos crÃ©ditos se aplican automÃ¡ticamente como descuento en tu prÃ³xima suscripciÃ³n.
                    Â¡Aprende mÃ¡s para ahorrar mÃ¡s! ðŸŽ“
                  </p>
                </div>
              </div>
            </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-3xl font-bold text-gray-900">MÃ³dulos Educativos</h2>
              <p className="text-gray-600 mt-1">Selecciona un mÃ³dulo para comenzar tu aprendizaje</p>
            </div>
          </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xs font-bold text-gray-500">MÃ“DULO {module.orden}</span>
                          {isLocked && (
                            <span className="text-xs bg-gray-200 text-gray-600 px-2 py-1 rounded-full">ðŸ”’ Bloqueado</span>
                          )}
                        </div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-5">
                      ...
                      <span className="text-xs px-3 py-1.5 rounded-full bg-purple-100 text-purple-700 font-semibold border border-purple-300">
                        â±ï¸ {module.duracion_minutos} min
                      </span>
                    ...
                    {module.total_preguntas > 0 && (
                      <div className="bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-xl mb-5 border-2 border-yellow-300">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="font-bold text-orange-900">{module.total_preguntas} Preguntas de EvaluaciÃ³n</span>
                        </div>
                        {module.puntos_quiz_perfecto ? (
                          <div className="flex items-start gap-2 text-sm">
                            ...
                            <p className="text-yellow-800">
                              ...
                              <strong className="text-green-700"> Q{((module.puntos_completar + module.puntos_quiz_perfecto) * 0.05).toFixed(2)}</strong> en crÃ©ditos
                            </p>
                          </div>
                        ) : (
                          <div className="flex items-start gap-2 text-sm">
                    ...
                    >
                      {loadingModule ? (
                        ...
                        <>ðŸ”’ Completa el mÃ³dulo anterior</>
                      ) : isCompleted ? (
                        <>
                          <CheckCircle size={20} />
                          Revisar MÃ³dulo
                      ...
                      <div className="relative">
                        <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-8 rounded-2xl border-2 border-blue-200 min-h-[400px] shadow-lg">
                          ...
                          <div className="prose max-w-none">
                            ...
                            // TIP/NOTA Box
                            if (paragraph.toLowerCase().startsWith('tip:') || paragraph.toLowerCase().startsWith('ðŸ’¡')) {
                              const content = paragraph.replace(/^(tip:|ðŸ’¡)/i, '').trim();
                              return (
                                <div key={index} className="bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-yellow-500 p-5 rounded-r-xl my-4 shadow-sm">
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      <p className="font-bold text-yellow-800 mb-1">ðŸ’¡ Consejo</p>
                            ...
                            // WARNING Box
                            if (paragraph.toLowerCase().startsWith('advertencia:') || paragraph.toLowerCase().startsWith('âš ï¸')) {
                              const content = paragraph.replace(/^(advertencia:|âš ï¸)/i, '').trim();
                              return (
                                <div key={index} className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-5 rounded-r-xl my-4 shadow-sm">
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      <p className="font-bold text-red-800 mb-1">âš ï¸ Advertencia</p>
                            ...
                            // INFO Box
                            if (paragraph.toLowerCase().startsWith('nota:') || paragraph.toLowerCase().startsWith('â„¹ï¸')) {
                              const content = paragraph.replace(/^(nota:|â„¹ï¸)/i, '').trim();
                              return (
                                <div key={index} className="bg-gradient-to-r from-blue-50 to-cyan-50 border-l-4 border-blue-500 p-5 rounded-r-xl my-4 shadow-sm">
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      <p className="font-bold text-blue-800 mb-1">â„¹ï¸ InformaciÃ³n</p>
                            ...
                            // FAQ/Question Box
                            if (paragraph.toLowerCase().startsWith('pregunta:') || paragraph.toLowerCase().startsWith('â“')) {
                              const content = paragraph.replace(/^(pregunta:|â“)/i, '').trim();
                              return (
                                <div key={index} className="bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-500 p-5 rounded-r-xl my-4 shadow-sm">
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                      <p className="font-bold text-purple-800 mb-1">â“ Pregunta Frecuente</p>
                          ...
                          <div className="flex items-center justify-center mt-6 pt-4 border-t border-blue-200">
                            <p className="text-sm text-blue-700 font-medium">
                              {contentSlide < contentSlides.length - 1
                                ...
                                : 'Â¡Has completado la lectura! ContinÃºa al quiz'}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      {contentSlide === contentSlides.length - 1 && selectedModule.total_preguntas > 0 && (
                        <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 p-8 rounded-2xl border-2 border-purple-300 shadow-lg">
                          <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                              <h4 className="font-bold text-purple-900 text-2xl">EvaluaciÃ³n de Conocimientos</h4>
                          ...
                          <div className="grid md:grid-cols-3 gap-4 mt-6">
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-5 rounded-xl shadow-md border-2 border-green-300">
                              ...
                              <p className="text-sm text-gray-600 font-semibold">CrÃ©ditos mÃ¡ximos</p>
                            </div>
                          </div>

                          <div className="mt-6 bg-white/80 p-5 rounded-xl border border-purple-200">
                            <p className="text-gray-700 leading-relaxed">
                              <strong className="text-purple-900">ðŸ’¡ Recuerda:</strong> Los crÃ©ditos se calculan automÃ¡ticamente
                              (Q1 por cada 20 puntos) y se aplicarÃ¡n como descuento en tu prÃ³xima suscripciÃ³n.
                              Â¡ObtÃ©n 100% de respuestas correctas para el bonus mÃ¡ximo!
                            </p>
                          </div>
                        </div>
                      )}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl shadow-xl">
                      ...
                      <p className="text-blue-100 text-lg mb-6">
                        Responde todas las preguntas cuidadosamente. Â¡Buena suerte! ðŸ€
                      </p>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className={`p-10 rounded-3xl text-center shadow-2xl ${
                      ...
                      <h3 className="text-5xl font-bold mb-4">
                        {quizResult.quiz_perfecto ? 'Â¡PERFECTO! ðŸŽ‰' :
                         quizResult.porcentaje >= 70 ? 'Â¡MUY BIEN! âœ…' :
                         'Â¡SIGUE INTENTANDO! ðŸ“š'}
                      </h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        ...
                        <div className="bg-white/20 rounded-2xl p-8 backdrop-blur-sm border-2 border-white/30">
                          ...
                          <p className="text-lg opacity-90">CrÃ©ditos Ganados</p>
                        </div>
                      </div>

                      {quizResult.quiz_perfecto && (
                        <div className="mt-8 bg-white/20 rounded-2xl p-6 backdrop-blur-sm border-2 border-white/30">
                          <p className="text-2xl font-bold mb-2">ðŸ† Â¡QUIZ PERFECTO!</p>
                      ...
                      <div className="mt-8 bg-white/30 rounded-2xl p-6 backdrop-blur-sm border-2 border-white/40">
                        <p className="text-lg leading-relaxed">
                          ðŸ’° Tus crÃ©ditos de <strong className="text-2xl">Q{quizResult.creditos_ganados.toFixed(2)}</strong> se
                          aplicarÃ¡n automÃ¡ticamente como descuento en tu prÃ³xima suscripciÃ³n
                        </p>
                      </div>
                      ...
                      {quizResult.logros_desbloqueados && quizResult.logros_desbloqueados.length > 0 && (
                        <div className="mt-8 bg-white/20 rounded-2xl p-6 backdrop-blur-sm border-2 border-white/30">
                          ...
                          <p className="font-bold text-2xl mb-4">ðŸŽ–ï¸ Â¡LOGROS DESBLOQUEADOS!</p>
                          <div className="space-y-2">
                            {quizResult.logros_desbloqueados.map((logro: any, i: number) => (
                              <p key={i} className="text-lg font-semibold">
                                ðŸ† {logro.nombre} <span className="text-yellow-200">(+{logro.puntos_bonus} pts)</span>
                              </p>
                            ))}
                          </div>
                        </div>
                      ...
                      {quizResult.recompensas_codigo && quizResult.recompensas_codigo.length > 0 && (
                        <div className="mt-8 bg-gradient-to-br from-green-400/30 to-emerald-400/30 rounded-2xl p-6 backdrop-blur-sm border-2 border-green-300/50">
                          ...
                          <p className="font-bold text-2xl mb-4">ðŸŽ Â¡CÃ“DIGOS PROMOCIONALES GANADOS!</p>
                          <p className="text-green-100 mb-4">Usa estos cÃ³digos para obtener descuentos en tus suscripciones</p>
                          ...
                          <p className="text-sm text-green-100 mt-4">
                            ðŸ’¡ Tus cÃ³digos estÃ¡n guardados en tu perfil y secciÃ³n de Recompensas
                          </p>
                        </div>
                      )}
                    </div>
