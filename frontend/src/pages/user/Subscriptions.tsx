...
const ALL_SERVICES: ServiceItem[] = [
  // VIAL SERVICES (Plan Drive) - Prices in GTQ
  // Combo plan includes ALL Drive services
  { id: 'grua', name: 'Grua del Vehiculo (Accidente o falla mecanica)', category: 'vial', driveLimit: '3/año', driveValue: 'Q1,163', healthLimit: '-', healthValue: '-', comboLimit: '3/año', comboValue: 'Q1,163' },
  { id: 'combustible', name: 'Abasto de Combustible (1 galon)', category: 'vial', driveLimit: 'Incluido', driveValue: 'Incluido', healthLimit: '-', healthValue: '-', comboLimit: 'Incluido', comboValue: 'Incluido' },
  { id: 'neumaticos', name: 'Cambio de Neumaticos', category: 'vial', driveLimit: '3/año', driveValue: 'Q1,163', healthLimit: '-', healthValue: '-', comboLimit: '3/año', comboValue: 'Q1,163' },
  { id: 'corriente', name: 'Paso de Corriente', category: 'vial', driveLimit: 'Incluido', driveValue: 'Incluido', healthLimit: '-', healthValue: '-', comboLimit: 'Incluido', comboValue: 'Incluido' },
  { id: 'cerrajeria', name: 'Emergencia de Cerrajeria', category: 'vial', driveLimit: 'Incluido', driveValue: 'Incluido', healthLimit: '-', healthValue: '-', comboLimit: 'Incluido', comboValue: 'Incluido' },
  { id: 'ambulancia_vial', name: 'Ambulancia por Accidente (Vial)', category: 'vial', driveLimit: '1/año', driveValue: 'Q775', healthLimit: '-', healthValue: '-', comboLimit: '3/año', comboValue: 'Q1,938' },
  { id: 'conductor', name: 'Conductor Profesional (enfermedad/embriaguez)', category: 'vial', driveLimit: '1/año', driveValue: 'Q465', healthLimit: '-', healthValue: '-', comboLimit: '1/año', comboValue: 'Q465' },
  { id: 'taxi_aeropuerto', name: 'Taxi al Aeropuerto (viaje al extranjero)', category: 'vial', driveLimit: '1/año', driveValue: 'Q465', healthLimit: '-', healthValue: '-', comboLimit: '1/año', comboValue: 'Q465' },
  { id: 'legal', name: 'Asistencia Legal Telefonica', category: 'vial', driveLimit: '1/año', driveValue: 'Q1,550', healthLimit: '-', healthValue: '-', comboLimit: '1/año', comboValue: 'Q1,550' },
  { id: 'emergencia_hospital', name: 'Apoyo Economico Sala de Emergencia', category: 'vial', driveLimit: '1/año', driveValue: 'Q7,750', healthLimit: '-', healthValue: '-', comboLimit: '1/año', comboValue: 'Q7,750' },
  { id: 'rayos_x', name: 'Rayos X', category: 'vial', driveLimit: '1/año', driveValue: 'Q2,325', healthLimit: '-', healthValue: '-', comboLimit: '1/año', comboValue: 'Q2,325' },
  ...
  { id: 'cotizacion_repuestos', name: 'Asistente Cotizacion de Repuestos', category: 'vial', driveLimit: 'Incluido', driveValue: 'Incluido', healthLimit: '-', healthValue: '-', comboLimit: 'Incluido', comboValue: 'Incluido' },
  { id: 'referencias_medicas', name: 'Asistente Referencias Medicas (accidente)', category: 'vial', driveLimit: 'Incluido', driveValue: 'Incluido', healthLimit: '-', healthValue: '-', comboLimit: 'Incluido', comboValue: 'Incluido' },

  // SALUD SERVICES (Plan Health) - Prices in GTQ
  // Combo plan includes ALL Health services with enhanced limits
  { id: 'orientacion_medica', name: 'Orientacion Medica Telefonica', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: 'Ilimitado', healthValue: 'Incluido', comboLimit: 'Ilimitado', comboValue: 'Incluido' },
  { id: 'especialistas', name: 'Conexion con Especialistas de la Red', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: 'Ilimitado', healthValue: 'Incluido', comboLimit: 'Ilimitado', comboValue: 'Incluido' },
  { id: 'consulta_presencial', name: 'Consulta Presencial (General/Ginecologo/Pediatra)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '3/año', healthValue: 'Q1,163', comboLimit: '6/año', comboValue: 'Q2,325' },
  { id: 'medicamentos', name: 'Coordinacion Medicamentos a Domicilio', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: 'Incluido', healthValue: 'Incluido', comboLimit: 'Incluido', comboValue: 'Incluido' },
  { id: 'enfermera', name: 'Cuidados Post Operatorios (Enfermera)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '1/año', healthValue: 'Q775', comboLimit: '1/año', comboValue: 'Q775' },
  { id: 'aseo', name: 'Articulos de Aseo por Hospitalizacion', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '1/año', healthValue: 'Q775', comboLimit: '1/año', comboValue: 'Q775' },
  { id: 'lab_basico', name: 'Examenes Lab (Heces, Orina, Hematologia)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '2/año', healthValue: 'Q775', comboLimit: '2/año', comboValue: 'Q775' },
  { id: 'lab_especial', name: 'Examenes Lab (Papanicolau/Mamografia/Antigeno)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '2/año', healthValue: 'Q775', comboLimit: '2/año', comboValue: 'Q775' },
  { id: 'nutricionista', name: 'Nutricionista Video Consulta (Grupo Familiar)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '4/año', healthValue: 'Q1,163', comboLimit: '8/año', comboValue: 'Q2,325' },
  { id: 'psicologia', name: 'Psicologia Video Consulta (Nucleo Familiar)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '4/año', healthValue: 'Q1,163', comboLimit: '8/año', comboValue: 'Q2,325' },
  { id: 'mensajeria', name: 'Mensajeria por Hospitalizacion Emergencia', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '2/año', healthValue: 'Q465', comboLimit: '2/año', comboValue: 'Q465' },
  { id: 'taxi_familiar', name: 'Taxi Familiar por Hospitalizacion (15km)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '2/año', healthValue: 'Q775', comboLimit: '2/año', comboValue: 'Q775' },
  { id: 'ambulancia_salud', name: 'Traslado Ambulancia por Accidente', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '2/año', healthValue: 'Q1,163', comboLimit: '2/año', comboValue: 'Q1,163' },
  { id: 'taxi_alta', name: 'Taxi al Domicilio tras Alta (15km)', category: 'salud', driveLimit: '-', driveValue: '-', healthLimit: '1/año', healthValue: 'Q775', comboLimit: '1/año', comboValue: 'Q775' },
];
...
const MAWDY_BENEFITS: Record<string, {
  ...
  'Drive': {
    planType: 'vial',
    serviciosIncluidos: [
      { icon: <Truck size={20} />, title: 'Grua del Vehiculo', description: 'Por accidente o falla mecanica', limit: '3/año - Q1,163' },
      { icon: <Fuel size={20} />, title: 'Abasto de Combustible', description: '1 galon (demostrar con imagen)', limit: 'Incluido' },
      { icon: <Car size={20} />, title: 'Cambio de Neumaticos', description: 'Instalacion de llanta de repuesto', limit: '3/año - Q1,163' },
      { icon: <Zap size={20} />, title: 'Paso de Corriente', description: 'Servicio de arranque de bateria', limit: 'Incluido' },
      { icon: <Key size={20} />, title: 'Emergencia de Cerrajeria', description: 'Apertura de vehiculo 24/7', limit: 'Incluido' },
      { icon: <Ambulance size={20} />, title: 'Ambulancia por Accidente', description: 'Traslado medico de emergencia', limit: '1/año - Q775' },
      { icon: <Users size={20} />, title: 'Conductor Profesional', description: 'Por enfermedad o embriaguez (5hrs anticipacion)', limit: '1/año - Q465' },
      { icon: <Car size={20} />, title: 'Taxi al Aeropuerto', description: 'Por viaje del titular al extranjero', limit: '1/año - Q465' },
      { icon: <Scale size={20} />, title: 'Asistencia Legal Telefonica', description: 'Asesoria legal por accidente', limit: '1/año - Q1,550' },
      { icon: <Heart size={20} />, title: 'Apoyo Economico Emergencia', description: 'Pago directo al hospital por accidente', limit: '1/año - Q7,750' },
      { icon: <FileText size={20} />, title: 'Rayos X', description: 'Servicio de radiografia', limit: '1/año - Q2,325' },
    ],
    beneficiosPremium: [
      { icon: <Star size={20} />, title: 'Descuentos en Red', description: 'Hasta 20% en proveedores asociados' },
      { icon: <Phone size={20} />, title: 'Cotizacion de Repuestos', description: 'Asistente telefonico para cotizaciones' },
      { icon: <Heart size={20} />, title: 'Referencias Medicas', description: 'Asistente para referencias por accidente' },
  ...
  'Health': {
    ...
    serviciosIncluidos: [
      ...
      { icon: <Heart size={20} />, title: 'Consulta Presencial', description: 'Medico general, ginecologo o pediatra (grupo familiar)', limit: '3/año - Q1,163' },
      { icon: <Truck size={20} />, title: 'Medicamentos a Domicilio', description: 'Coordinacion de envio de medicamentos', limit: 'Incluido' },
      { icon: <Home size={20} />, title: 'Cuidados Post Operatorios', description: 'Enfermera para el titular', limit: '1/año - Q775' },
      { icon: <FileText size={20} />, title: 'Articulos de Aseo', description: 'Envio por hospitalizacion', limit: '1/año - Q775' },
      { icon: <FileText size={20} />, title: 'Examenes de Laboratorio', description: 'Heces, orina y hematologia (grupo familiar)', limit: '2/año - Q775' },
      { icon: <FileText size={20} />, title: 'Examenes Especializados', description: 'Papanicolau, mamografia o antigeno prostatico', limit: '2/año - Q775' },
      { icon: <Users size={20} />, title: 'Nutricionista Video', description: 'Video consulta (grupo familiar)', limit: '4/año - Q1,163' },
      { icon: <Heart size={20} />, title: 'Psicologia Video', description: 'Video consulta (nucleo familiar)', limit: '4/año - Q1,163' },
      { icon: <Truck size={20} />, title: 'Mensajeria Hospitalizacion', description: 'Servicio de mensajeria por emergencia', limit: '2/año - Q465' },
      { icon: <Car size={20} />, title: 'Taxi Familiar', description: 'Por hospitalizacion del titular (15km)', limit: '2/año - Q775' },
      { icon: <Ambulance size={20} />, title: 'Ambulancia por Accidente', description: 'Traslado del titular', limit: '2/año - Q1,163' },
      { icon: <Car size={20} />, title: 'Taxi Post Alta', description: 'Traslado al domicilio tras hospitalizacion', limit: '1/año - Q775' },
    ],
    beneficiosPremium: [
      ...
      { icon: <Shield size={20} />, title: 'Red de Especialistas', description: 'Acceso a red medica MAWDY' },
    ],
    coberturaKm: 15,
    eventosAnuales: '14+',
  ...
  'Combo': {
    ...
    serviciosIncluidos: [
      { icon: <Truck size={20} />, title: 'Grua del Vehiculo', description: 'Por accidente o falla mecanica', limit: '3/año - Q1,163' },
      { icon: <Fuel size={20} />, title: 'Abasto de Combustible', description: '1 galon con imagen', limit: 'Incluido' },
      { icon: <Car size={20} />, title: 'Cambio de Neumaticos', description: 'Instalacion de llanta', limit: '3/año - Q1,163' },
      { icon: <Zap size={20} />, title: 'Paso de Corriente', description: 'Arranque de bateria', limit: 'Incluido' },
      { icon: <Key size={20} />, title: 'Cerrajeria Automotriz', description: 'Apertura de vehiculo', limit: 'Incluido' },
      { icon: <Ambulance size={20} />, title: 'Ambulancia', description: 'Por accidente vial o medico', limit: '3/año - Q1,938' },
      { icon: <Heart size={20} />, title: 'Consultas Medicas', description: 'Presencial y video (grupo familiar)', limit: '6/año - Q2,325' },
      { icon: <Scale size={20} />, title: 'Asistencia Legal', description: 'Asesoria telefonica', limit: '1/año - Q1,550' },
