...
Asistencias SegurifAI incluidas."""
            ...
            plans_data = [
                ...
                # PROTEGE TU SALUD (Asistencia Médica) - Q34.99 - All limits in GTQ
                {
                    'category': health_cat,
                    ...
                    'max_requests_per_month': 3,
                    'coverage_amount': 10608.00,
                    'is_active': True,
                    'is_featured': True
                },

                # PROTEGE TU RUTA (Asistencia Vial) - Q39.99 - All limits in GTQ
                {
